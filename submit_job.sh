...
DATASET_TARGET_KEY='elec._Free_Energy_[eV]' # 'energy' 'elec._Free_Energy_[eV]' 'U0'
N_TRAIN=1000
N_TEST=1000
################################################
...
OUTPUT_PATH='/home/ach/radial-physics_new/radial-physics/output/dataset_comp_old_calcs'
